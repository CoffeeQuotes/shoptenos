...
@section('content')
  ...
  <div class="container">
    <div class="row py-4">
      ...
      <div class="col s12 m6">
          <div class="card">
            <h2 class="blue-grey-text card-title">{{ ucfirst($product->name) }}</h2>
            ...
            <div class="grp-buttons">
                <a class="waves-effect waves-light btn-large  blue darken-1 white-text"><i class="material-icons left">add_shopping_cart</i>Add to Cart</a>
