...
<div class="container">
    <div class="row">
        <form class="col s12 m8" action="" method="POST">
            ...
            <div class="row">
                <div class="input-field col s12 m4">
                  <input placeholder="PIN Code" id="pincode" type="text" class="validate">
            ...
            @if (session('cart'))
                ...
                <div class="row">
                    ...
                    <div class="s8 col m8">
                        ...
                        <br>
                        <span class="indigo-text">Quantity: {{ $details['quantity'] }}</span>
                        <br>
                        <span class="blue-grey-text">₹ {{ $details['price'] }}</span>
                        <br><b>Subtotal: ₹{{ $details['price'] * $details['quantity'] }}</b>
                    </div>
                </div>
                @endforeach
                <div class="row">
                    <div class="s4 m4 text-right">
