    ...
    <div class="row">
        <form class="col s12 m8" action="{{ route('checkout')}}" method="POST">
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                  <input placeholder="Last name" name="lastname" id="last_name" type="text" class="validate">
            ...
            <div class="row">
                <div class="input-field col s12 m4">
                  <input placeholder="PIN Code" name="pincode" id="pincode" type="text" pattern="[1-9][0-9]{5} class="validate">
                  <label for="Pincode">PIN Code</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
                    <input placeholder="Phone" name="phone" id="icon_telephone" type="tel" class="validate">
