...
<div class="container">
    <div class="row">
        <form class="col s12 m8" action="" method="POST">
            ...
            <a class="waves-effect waves-light btn-large">Return To Cart</a>
            <button class="btn waves-effect waves-light" type="submit" name="action"><i class="material-icons right">local_shipping
