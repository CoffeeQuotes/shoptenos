    ...
    <div class="row py-4">
      ...
      <div class="col s12 m6">
        ...
        <div class="grp-buttons">
            <a class="waves-effect waves-light btn-large  indigo lighten-5 grey-text"><i class="material-icons left">add_shopping_cart</i>Add to Cart</a>
            <a class="waves-effect waves-light btn-large  indigo lighten-5 "><i class="material-icons left">add_shopping_cart</i>Add to Cart</a>
        </div>
      </div>
    </div>
