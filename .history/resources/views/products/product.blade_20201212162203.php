    ...
    <div class="row py-4">
      ...
      <div class="col s12 m6">
        ...
        <div class="collection">
            <a href="#!" class="collection-item"><span class="badge"> {{ $product->subject }}</span>Alan</a>
            <a href="#!" class="collection-item"><span class="new badge"> {{ $product->class }}</span>Alan</a>
            <a href="#!" class="collection-item"><span class="badge"> {{ $product->board }}</span>Alan</a>
        </div>
      </div>
    </div>
