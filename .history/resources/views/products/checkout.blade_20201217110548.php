        ...
        <form class="col s12 m8" action="{{ route('checkout')}}" method="POST">
            ...
            <textarea name="products" class="hide">
                ...
                @if (session('cart'))
                    ...
                    @endforeach
                    Total: ₹ {{ $total }}
                    <input name="amount" type="hidden" class="validate" required>
                @endif;
            </textarea>
            <div class="row">
                ...
                <div class="s12 col m6">
                    <button class="btn green accent darken-3 waves-effect waves-light btn-large" type="submit" name="action"><i class="material-icons right">local_shipping
