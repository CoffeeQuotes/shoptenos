...
@section('content')
<div id="index-banner" class="parallax-container" style="background-color: rgba(100,100,200,0.2);">
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <h2 class="header light amber-text"  style="letter-spacing:2px; padding-top: 12px; padding-bottom: 12px;">Education Resources</h2>
        </div>
        <div class="row center">
          <a href="/products" id="download-button" class="btn-large waves-effect waves-light" style="background-color: rgba(0,200,0,0.1);">Browse</a>
        </div>
        <br><br>
