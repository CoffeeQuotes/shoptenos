    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <h2 class="header light amber-text"  style="width: 80%; letter-spacing:2px; padding-top: 12px; padding-bottom: 12px; background-color: rgba(0,0,0,0.4)">Education Resources</h2>
        </div>
        <div class="row center">
