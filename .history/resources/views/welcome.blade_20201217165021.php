...
<div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <a href="/products" id="download-button" class="btn-large waves-effect waves-light blue lighten-1">Browse</a>
        </div>
        <br><br>

      </div>
    </div>
<div class="parallax"><img src="{{asset('img/hero.jpg')}}" alt="Teacher teaching in class room on white board" width="1280" height="853"></div>
  </div>
   <div class="container">
    <div class="section">
