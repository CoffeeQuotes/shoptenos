...
@section('content')
<div id="index-banner" class="parallax-container" style="background-color: rgba(0,0,0,0.4);">
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <a href="/products" id="download-button" class="btn-large waves-effect waves-light" style="background-color: rgba(0,0,200,0.1);">Browse</a>
        </div>
        <br><br>
